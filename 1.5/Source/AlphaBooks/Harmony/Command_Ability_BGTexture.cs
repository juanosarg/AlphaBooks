...
namespace AlphaBooks
{
    ...
    static class AlphaBooks_Command_Ability_BGTexture_Patch
    {

        [HarmonyPostfix]
        public static void ChangeBG(Command_Ability __instance, ref Texture2D __result)
        {
            if (StaticCollections.chargeAbilities.Contains(__instance.Ability.def))
            {
    ...
    static class AlphaBooks_Command_Ability_BGTextureShrunk_Patch
    {
